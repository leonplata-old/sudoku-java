...
public class CajaSudoku implements Serializable {
     ...
     * @return El n�mero en la fila y columna dada, si la fila o columna no existen
     * devuelve -1.
     */
    ...
    /**
     * Controla que la fila y la columna están dentro del rango de la matriz.
     * @param fil La fila.
     * @param col La columna.
     */
     ...
     * Sudoku e insertar los números, estos solo se situaron en las casillas bloqueadas
